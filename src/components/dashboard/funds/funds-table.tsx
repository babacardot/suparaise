  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        {queueStatus && (
          <div className="mb-4 p-4 bg-slate-50 dark:bg-slate-900/30 rounded-sm border">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex gap-1">
                    {Array.from({ length: queueStatus.maxParallel }, (_, i) => (
                      <div
                        key={i}
                        className={`w-6 h-6 rounded-sm border-2 flex items-center justify-center text-xs font-bold ${i < queueStatus.currentInProgress
