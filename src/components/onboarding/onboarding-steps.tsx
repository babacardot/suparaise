    ...
    <div className="space-y-3">
      ...
      {!file ? (
        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 space-y-3 sm:space-y-0">
          <div
            className={`h-20 w-20 border-2 border-dashed rounded-sm flex items-center justify-center ${
              type === 'pitchDeck'
              ...
              >
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="text-xs text-foreground/80 space-y-0.5">
                    <p>
                      <span className="font-bold">Email</span> {founder.email}
                    </p>
                    {founder.phone && (
                      <p>
                        <span className="font-bold">Phone</span> {founder.phone}
                      </p>
                    )}
                    {founder.linkedin && (
                      <p>
