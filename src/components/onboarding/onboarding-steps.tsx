      ...
      <div className="space-y-3">
        ...
        {!file ? (
          <div className="flex flex-col sm:flex-row items-center sm:space-x-4 space-y-3 sm:space-y-0">
            <div
              className={`h-20 w-20 border-2 border-dashed rounded-sm flex items-center justify-center ${type === 'pitchDeck'
                ? 'bg-cyan-50 dark:bg-cyan-900/20 border-cyan-200 dark:border-cyan-800'
                : 'bg-background dark:bg-muted border-border'
                }`}
            >
              <LottieIcon
            ...
            <div className="space-x-2">
              <Button
                ...
                disabled={uploadStatus === 'uploading'}
                className={`rounded-sm border ${type === 'pitchDeck'
                  ? 'bg-cyan-50 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 hover:bg-cyan-100 dark:hover:bg-cyan-900/40 hover:text-cyan-800 dark:hover:text-cyan-200 border-cyan-200 dark:border-cyan-800'
          ...
          <div className="space-y-3">
            ...
            <div className="flex">
              <Input
                ...
                autoComplete="url"
                className={`rounded-l-sm rounded-r-none ${fieldErrors.website
                  ? 'border-red-500 focus:border-red-500'
                  : ''
                  }`}
              />
              <Button
                ...
                className="shrink-0 px-3 h-9 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-900/40 hover:text-purple-800 dark:hover:text-purple-200 border border-purple-200 dark:border-purple-800 rounded-r-sm rounded-l-none"
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
            ...
            <div className="relative -mt-3">
              <span className="absolute top-2 right-2 z-10 text-xs bg-cyan-50 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-800 px-1.5 py-0.5 rounded">
                BETA
              </span>
              ...
              >
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="text-xs text-foreground/80 space-y-0.5">
                    <p><span className="font-bold">Email</span> {founder.email}</p>
                    {founder.phone && <p><span className="font-bold">Phone</span> {founder.phone}</p>}
                    {founder.linkedin && <p><span className="font-bold">LinkedIn</span> {founder.linkedin}</p>}
                    {founder.githubUrl && <p><span className="font-bold">Github</span> {founder.githubUrl}</p>}
                    {founder.twitterUrl && <p><span className="font-bold">X</span> {founder.twitterUrl}</p>}
                    {founder.personalWebsiteUrl && (
                      <p><span className="font-bold">Website</span> {founder.personalWebsiteUrl}</p>
                    )}
                    {founder.bio && (
