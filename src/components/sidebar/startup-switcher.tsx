...
export function StartupSwitcher({
    ...
    return (
        <Popover open={open} onOpenChange={handlePopoverChange}>
            ...
            <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0 bg-sidebar border-sidebar-border" align="start">
                <Command className="bg-sidebar [&_[cmdk-item]]:aria-selected:bg-sidebar-accent [&_[cmdk-item]]:data-[selected=true]:bg-sidebar-accent" defaultValue="">
                    <CommandList>
                        {startups.length > 0 && (
                            <CommandGroup>
                        ...
                        <CommandGroup>
                            ...
                            >
                                <div className="flex items-center gap-2 min-w-0 w-full px-2 py-1.5">
                                    ...
                                    <span className="truncate group-data-[collapsible=icon]:hidden">Create</span>
                                </div>
                            </CommandItem>
                        </CommandGroup>
                    </CommandList>
