...
export function UserProvider({ children }: UserProviderProps) {
    ...
    const fetchStartups = useCallback(async () => {
        ...
        try {
            ...
            if (error) {
                ...
                const startupsArray = Array.isArray(startupsData) ? startupsData as unknown as StartupData[] : [];
    ...
    const selectStartup = useCallback(async (startupId: string) => {
    ...
    const selectStartupById = useCallback(async (startupId: string) => {
