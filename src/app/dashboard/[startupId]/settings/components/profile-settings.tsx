...
export default function ProfileSettings() {
    ...
    const handleFieldSave = async (field: string) => {
        ...
        try {
            ...
            const { data, error } = await supabase.rpc('update_user_founder_profile', {
                p_user_id: user.id,
                p_startup_id: currentStartupId,
                p_data: updateData
            })
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={cn("rounded-sm pr-8", editingField !== 'linkedin' && "bg-muted")}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={cn("rounded-sm pr-8", editingField !== 'githubUrl' && "bg-muted")}
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={cn("rounded-sm pr-8", editingField !== 'personalWebsiteUrl' && "bg-muted")}
