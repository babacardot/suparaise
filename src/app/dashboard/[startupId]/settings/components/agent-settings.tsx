...
export default function AgentSettings() {
    ...
    const [formData, setFormData] = useState({
        ...
        customInstructions: '',
        preferredTone: 'professional' as 'professional' | 'enthusiastic' | 'concise' | 'detailed',
    ...
    const fundStages = ['Pre-Seed', 'Seed', 'Series A', 'Series B', 'Series C+', 'Growth', 'Late Stage']
    const fundTypes = ['Venture Capital', 'Angel Group', 'Corporate VC', 'Accelerator', 'Government Grant', 'Family Office', 'Strategic Investor']
            ...
            <div className="flex-1 overflow-auto pt-6 max-h-[62vh] hide-scrollbar">
                <div className="space-y-6 pr-2">
                    ...
                    <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) => handleInputChange('submissionDelay', parseInt(e.target.value) || 30)}
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="space-y-2">
                                <Label htmlFor="maxParallelSubmissions">Max parallel submissions</Label>
                                <div className="relative">
                                    <Input
                                        id="maxParallelSubmissions"
                                        type="number"
                                        value={formData.maxParallelSubmissions}
                                        onChange={(e) => handleInputChange('maxParallelSubmissions', parseInt(e.target.value) || 3)}
                                        className={cn("rounded-sm pr-8", editingField !== 'maxParallelSubmissions' && "bg-muted")}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) => handleInputChange('timeoutMinutes', parseInt(e.target.value) || 10)}
                                        className={cn("rounded-sm pr-8", editingField !== 'timeoutMinutes' && "bg-muted")}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center space-x-3 p-3 border rounded-sm hover:bg-muted/50 transition-colors">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) => handleInputChange('skipVideoRequirements', checked)}
                                />
                                <div className="grid gap-1.5 leading-none flex-1">
                                    <Label htmlFor="skipVideoRequirements" className="font-medium">
                            ...
                            <div className="flex items-center space-x-3 p-3 border rounded-sm hover:bg-muted/50 transition-colors">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) => handleInputChange('enableStealth', checked)}
                                />
                                <div className="grid gap-1.5 leading-none flex-1">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {fundStages.map((stage) => (
                                        <Badge
                                            key={stage}
                                            variant={formData.targetFundStages.includes(stage) ? "default" : "outline"}
                            ...
                            <div>
                                <Label className="text-sm font-medium mb-2 block">Fund types</Label>
                                <div className="flex flex-wrap gap-2">
                                    {fundTypes.map((type) => (
                                        <Badge
                                            key={type}
                                            variant={formData.targetFundTypes.includes(type) ? "default" : "outline"}
                                            className="cursor-pointer hover:scale-105 transition-transform"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    onChange={async (e) => {
                                        const newValue = e.target.value as typeof formData.preferredTone
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) => handleInputChange('maxSteps', parseInt(e.target.value) || 50)}
                                        className={cn("rounded-sm pr-8", editingField !== 'maxSteps' && "bg-muted")}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        onChange={async (e) => {
                                            const newValue = e.target.value as typeof formData.browserProvider
                                ...
                                <p className="text-xs text-muted-foreground">
                                    {formData.browserProvider === 'Local' ? 'Uses local Playwright instance' : 'Uses cloud browsers with proxy support'}
                                </p>
                            </div>
                        </div>
                    </div>
