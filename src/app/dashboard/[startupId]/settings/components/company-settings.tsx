...
export default function CompanySettings() {
            ...
            <div className="h-full flex flex-col overflow-hidden">
                <div className="flex-shrink-0 pb-4">
                    ...
                    <p className="text-muted-foreground">
                        Tell us about your startup, what you&apos;re building and why it matters.
                    </p>
                </div>
    ...
    const handleInputChange = (field: string, value: string | IndustryType | LegalStructure | InvestmentStage | number | null) => {
                    ...
                    <div className="flex items-center space-x-4">
                        <Avatar className="h-20 w-20">
                            {formData.logoUrl ? (
                                ...
                                <AvatarFallback className="text-lg">{companyInitial}</AvatarFallback>
                            )}
                        </Avatar>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={cn("rounded-sm pr-8", editingField !== 'name' && "bg-muted")}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className={cn("rounded-sm pr-8", editingField !== 'descriptionShort' && "bg-muted")}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Textarea
                                    ...
                                    onChange={(e) => handleInputChange('descriptionMedium', e.target.value)}
                                    className={cn("rounded-sm pr-8 min-h-[80px]", editingField !== 'descriptionMedium' && "bg-muted")}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Textarea
                                    ...
                                    onChange={(e) => handleInputChange('descriptionLong', e.target.value)}
                                    className={cn("rounded-sm pr-8 min-h-[120px]", editingField !== 'descriptionLong' && "bg-muted")}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className={cn("rounded-sm pr-8", editingField !== 'revenueModel' && "bg-muted")}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Textarea
                                    ...
                                    onChange={(e) => handleInputChange('keyCustomers', e.target.value)}
                                    className={cn("rounded-sm pr-8 min-h-[80px]", editingField !== 'keyCustomers' && "bg-muted")}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Textarea
                                    ...
                                    className={cn("rounded-sm pr-8 min-h-[80px]", editingField !== 'competitors' && "bg-muted")}
